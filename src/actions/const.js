...
// 获取单个代理商详情
export const GET_SINGLE_AGENT_INFO = "GET_SINGLE_AGENT_INFO"
// 创建一个商品
export const CREATE_GOOD = "CREATE_GOOD"
// 加载商品列表
export const LOADING_GOODS_LIST = "LOADING_GOODS_LIST"
// 更新商品信息
export const UPDATE_GOOD_INFO = "UPDATE_GOOD_INFO"
// 获取单个商品信息
export const GET_SINGLE_GOOD_INFO = "GET_SINGLE_GOOD_INFO"
// 删除一个商品
